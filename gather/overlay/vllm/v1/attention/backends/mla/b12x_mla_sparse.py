...
class B12xMLASparseImpl(SparseMLAAttentionImpl[B12xMLASparseMetadata]):
    ...
    def _dcp_gather_ckv(
        ...
        if (
            ...
            != (self.block_size, _NVFP4_CKV_RECORD_BYTES)
        ...
        ckv_workspace = ckv_workspace.view(-1, _NVFP4_CKV_RECORD_BYTES)
        local_buffer = ckv_workspace[: self._ckv_local_capacity]
        gathered_buffer = ckv_workspace[
            self._ckv_local_capacity : self._ckv_local_capacity
            * (self.dcp_world_size + 1)
        ]
        if local_tokens:
            ops.cp_gather_cache(
        ...
        return gathered_tokens.view(
            -1, self.block_size, _NVFP4_CKV_RECORD_BYTES
        )
